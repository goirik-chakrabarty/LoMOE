...
if __name__=="__main__":
    ...
    parser.add_argument('--latentlist', required=True)
    ...
    if os.path.isdir(args.inversion):
        ...
        l_latent_paths = sorted(glob.glob(os.path.join(args.latentlist, "*.pt")))
        ...
        l_latent_paths = [args.latentlist]
    ...
    for inv_path, prompt_path, latent_path in zip(l_inv_paths, l_prompt_paths, l_latent_paths):
        ...
        rec_pil, edit_pil = pipe(prompt_str,
                ...
                latent_list=torch.load(latent_path)
        )
