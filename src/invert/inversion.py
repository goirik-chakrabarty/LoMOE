...
if __name__=="__main__":
    ...
    parser.add_argument('--input_image', type=str, default='assets/dataset/1/init_image.jpeg')
    parser.add_argument('--results_folder', type=str, default='output/1')
    ...
    os.makedirs(os.path.join(args.results_folder, "latentlist"), exist_ok=True)
    ...
    for img_path in l_img_paths:
        ...
        x_inv=latent_list[-1].detach()

        torch.save(latent_list, os.path.join(args.results_folder, f"latentlist/{bname}.pt"))
        # save the inversion
        ...
        os.makedirs(os.path.join(args.results_folder, "original"), exist_ok=True)
        img.save(os.path.join(args.results_folder, f"original/{bname}.png"))
