...
def main():
    ...
    parser.add_argument(
        "--ckpt",
        type=str,
        default="/home/prathosh/goirik/DiffEdit-stable-diffusion/ldm/models/ldm/stable-diffusion-v1/sd-v1-4.ckpt",
...
def diffedit(model, init_image, mask,
    ...
    :param mask: masked area to be edit
    ...
    with torch.no_grad():
        with precision_scope(device.type):
            with model.ema_scope():
                ...
                # get mask
                # mask = get_mask(model, src, dst, init_latent, 3, ddim_steps) # Goirik
                def to_binary(pix):
                    if pix > 0.5:
                        return 1
                    else:
                ...
                mask = np.array(Image.open(mask).resize([64,64]))
                mask = torch.tensor(mask).apply_(to_binary).cuda()                
...
model, opt = main()
res = diffedit(model, init_image=opt.origin_image, mask=opt.mask_path, src_prompt=opt.prompt, dst_prompt=opt.prompt_edit, seed=opt.seed)
Image.fromarray(res[0]).save(opt.out_path)

# res = diffedit(model, init_image="/home/prathosh/goirik/DiffEdit-stable-diffusion/inputs/recon/2.png", mask='/home/prathosh/goirik/DiffEdit-stable-diffusion/inputs/masks/2.png', src_prompt='a group of horses', dst_prompt='a group of zebras')
# res = diffedit(model, "/home/prathosh/goirik/DiffEdit-stable-diffusion/inputs/recon/3.png", src_prompt='a cat', dst_prompt='a orange real dog')


# python diffedit.py --prompt 'a group of horses' --prompt_edit 'a group of zebras' --origin_image "/home/prathosh/goirik/DiffEdit-stable-diffusion/inputs/recon/2.png" --mask_path '/home/prathosh/goirik/DiffEdit-stable-diffusion/inputs/masks/2.png'
# python diffedit.py --prompt 'a cat' --prompt_edit 'a orange real dog' --origin_image "/home/prathosh/goirik/DiffEdit-stable-diffusion/inputs/recon/3.png" --mask_path '/home/prathosh/goirik/DiffEdit-stable-diffusion/inputs/masks/3.png' --out_path 'inputs/res/diff_out.jpg'